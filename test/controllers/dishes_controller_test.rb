...
class DishesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dish" do
    assert_difference('Dish.count') do
      post dishes_url, params: { dish: { description: @dish.description, time: @dish.time, value: @dish.value } }
    end
  ...
  test "should update dish" do
    patch dish_url(@dish), params: { dish: { description: @dish.description, time: @dish.time, value: @dish.value } }
